...
string plain_hash_concatenation(const string &plaintext)
{
    ...
    // Ensuring the hash value has 20 digits
    ...
    cout << "Hash: " << hash_converted << endl;
    cout << "New Plaintext: " << plaintext + hash_converted << endl;
...
int main()
{
    ...
    //creating ciphertexts including padding with "z"
    for (int i = 0; i < plaintexts_vec.size(); i++)
    {
        cout << "Ciphertext_"<<i+1<<": " << encrypt(key, plaintexts_vec[i]) << endl;
    }
    cout<<endl;

    cout<<endl;
    cout<<"---- Applying BruteForce to Discover Key ----"<<endl;
    cout<<endl;
